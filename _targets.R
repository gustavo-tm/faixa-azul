...
list(
  ...
  tar_target(
    ...
    command = prepara_agregado_did(dado_did_agregado_mes, dado_agregados,
                                   filtrar_por = NULL)),
  tar_target(
  ...
  tar_target(
    name = did_agregado_horario_05_10_todos,
    command = fit_csdid_full(
      ...
      ylim = 1.5)),
  tar_target(
    name = did_agregado_horario_05_10_moto,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
  ...
  tar_target(
    name = did_agregado_horario_11_16_todos,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      ...
      ylim = 1.5)),
  tar_target(
    name = did_agregado_horario_11_16_moto,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
  ...
  tar_target(
    name = did_agregado_horario_12_22_todos,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      ...
      ylim = 1.5)),
  tar_target(
    name = did_agregado_horario_12_22_moto,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
  ...
  tar_target(
    name = did_agregado_horario_17_20_todos,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      ...
      ylim = 1.5)),
  tar_target(
    name = did_agregado_horario_17_20_moto,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
  ...
  tar_target(
    name = did_agregado_horario_18_19_todos,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      ...
      ylim = 1.5)),
  tar_target(
    name = did_agregado_horario_18_19_moto,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
  ...
  tar_target(
    name = did_agregado_horario_17_20_choque,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      yname = "sinistros_hora_17_20_choque",
      titulo = "Choques, 17h-20h",
      filename = "agregado/het/horario/acidente/17_20-choque",
      ylim = 0.5)),
  tar_target(
    name = did_agregado_horario_17_20_colisao,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      yname = "sinistros_hora_17_20_colisao",
      titulo = "Colisões, 17h-20h",
      filename = "agregado/het/horario/acidente/17_20-colisao",
      ylim = 1.5)),
  tar_target(
    name = did_agregado_horario_17_20_atropelamento,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      yname = "sinistros_hora_17_20_atropelamento",
      titulo = "Atropelamentos, 17h-20h",
      filename = "agregado/het/horario/acidente/17_20-atropelamento",
      ylim = 0.5)),
  tar_target(
    name = did_agregado_horario_17_20_outros,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      yname = "sinistros_hora_17_20_outros",
      titulo = "Outros, 17h-20h",
      filename = "agregado/het/horario/acidente/17_20-outros",
      ylim = 1.5)),
  tar_target(
    name = did_agregado_horario_17_20_choque_colisao,
    command = fit_csdid_full(
      df = dado_did_agregado_golden,
      cohort = dado_cohort_agregado,
      yname = "sinistros_hora_17_20_choque_colisao",
      titulo = "Choques ou colisões, 17h-20h",
      filename = "agregado/het/horario/acidente/17_20-choque_colisao",
      ylim = 1.5)),
